 ...
 ?>
  ...
  <link rel="stylesheet" href="css/bootstrap-wysihtml5.css" />
    ...
    <div class="pageheader">
      <h2><i class="fa fa-th-list"></i> Hariri/editi aina ya matumizi</h2>
    </div>
...
$res = $pdo->exec("UPDATE expcat SET title='".$title."' WHERE id='".$eid."'");
...
$oldd = $pdo->query("SELECT title FROM expcat WHERE id='".$eid."'");
