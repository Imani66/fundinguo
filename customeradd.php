...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ongeza Mteja</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
";
  ...
  $(function() {
    $( "#datepicker" ).datepicker();
				...
				<div class="form-group">
				  <label class="col-sm-3 control-label">Maoni</label><br/><br/>
                ...
                <div class="form-group">
                    ...
                    <option value="1">Kike</option></select><br/><br/>
				</div>
