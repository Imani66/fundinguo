...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Editi/Hariri Wafanyakazi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
$res = $pdo->exec("UPDATE `staff` SET `stafftype`='".$stafftype."',`address`='".$address."',`fullname`='".$fullname."',`phonenumber`='".$phonenumber."',`salary`='".$salary."' WHERE id='".$eid."'");
	...
	Umehaariri/Umeediti kikamilifu!
	...
	Tatizo limekitokeza. Tafadhali jalibu tena. 
...
?>								
					...
					?>
					<option value="0">Tafadhali chagua idara</option>
					<?php
