...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Hariri/Editi sehemu ya Kipimo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
Kuna tatizo limejitokeza. Tafadhali jalibu tena. 
...
?>				
					...
					<label>Chagua aina ya kipimo</label>
					...
					?>
					<option value="0">Chagua aina</option>
					<?php
