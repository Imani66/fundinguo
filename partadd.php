...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ongeza sehemu ya kipimo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
Sehemu ya kipimo imeongezeka kikamilifu!
...
Tafadhali chagua aina!!!!
  ...
  $(function() {
    $( "#datepicker" ).datepicker();
					...
					<label>Chagua aina</label>
					
					<select name="type" class="form-control">
					<option value="0">Tafadhali chagua aina</option>
					<?php
