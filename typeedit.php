 ...
 ?>
  ...
  <link rel="stylesheet" href="css/bootstrap-wysihtml5.css" />
    ...
    <div class="pageheader">
      <h2><i class="fa fa-th-list"></i> Hariri/Editi orodha ya aina ya Nguo</h2>
    </div>
...
?>					
		...
		<form action="" method="post">
            ...
            <div class="form-group">
					...
					<label class="col-sm-3 control-label">Jinsia</label>
					
					<div class="col-sm-6"><select name="sex" class="form-control">
                        <option value="0" <?php if($old['sex']== 0) echo('selected = "selected"'); ?>>Kiume</option>
                        <option value="1"<?php if($old['sex']== 1) echo('selected = "selected"'); ?>>Kike</option>
					</select></div>
