...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
    ...
    <div class="pageheader">
      <h2><i class="fa fa-cog"></i>Mpangilio wa jumla </h2>
    </div>
...
$res = $pdo->exec("UPDATE general_setting SET sitename='".$sitename."', mobile='".$mobile."', email='".$email."', currency='".$currency."' WHERE id='1'");
if($res){
...
?>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">JINA LA KAMPUNI</label>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Namba ya simu</label>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">E-meil/Barua pepe</label>
              <div class="col-sm-6"><input name="email" value="<?php echo $data['email']; ?>" class="form-control" type="text"></div>
            </div>
            
            <div class="form-group">
              <label class="col-sm-3 control-label">Alama ya sarafu</label>
