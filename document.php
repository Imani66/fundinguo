...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
    ...
    <div class="pageheader">
      <h2><i class="fa fa-cog"></i> Kusimamia hati/Document ya ofisi</h2>
    </div>
...
Umeongeza Hati/Document kikamilifu!
...
?>	
		...
		<form name="" id="" action="" method="post" enctype="multipart/form-data" >
	            <div class="form-group">
                  <label class="col-sm-3 control-label">Jina la Documenti/Hati </label>
                  <div class="col-sm-6"><input name="title" value="" class="form-control" /></div><br/>
                </div>
                
                <div class="form-group">
                  <label class="col-sm-3 control-label">Maelezo ya Documenti/Hati</label>
                  <div class="col-sm-6"><input name="detail" value="" class="form-control" /></div>
                </div>
			
              	<div class="form-group">
                  <label class="col-sm-3 control-label">Picha ya Document/Hati  </label>
				...
				<div class="col-sm-6 col-sm-offset-3"><br/>
				  <button class="btn btn-primary btn-block" style="width:200px; height: 40px;">TUMA</button><br/><br/>
				</div>
                      ...
                      <table class="table table-striped" id="table2">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Jina</th>
                                            <th>Maelezo ya Documenti/Hati</th>
                                            <th>Tendo</th>
                                        </tr>
                                    </thead>
                                     <tbody>		  
