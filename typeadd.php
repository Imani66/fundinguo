 ...
 ?>
  ...
  <link rel="stylesheet" href="css/bootstrap-wysihtml5.css" />
    ...
    <div class="pageheader">
      <h2><i class="fa fa-th-list"></i> Ongeza aina mpya Nguo</h2>
    </div>
...
AINA MPYA YA NGUO imeongezeka kikamilifu!
...
?>	
		...
		<form action="" method="post">
			...
			<div class="form-group">
					...
					<option value="0">Kiume</option>
                    <option value="1">Kike</option></select></div>
				</div>  
