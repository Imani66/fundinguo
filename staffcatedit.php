 ...
 ?>
  ...
  <link rel="stylesheet" href="css/bootstrap-wysihtml5.css" />
    ...
    <div class="pageheader">
      <h2><i class="fa fa-th-list"></i> Hariri/ Editi idara ya wafanyakazi</h2>
    </div>
...
$res = $pdo->exec("UPDATE stafftype SET title='".$title."' WHERE id='".$eid."'");
...
$oldd = $pdo->query("SELECT title FROM stafftype WHERE id='".$eid."'");
