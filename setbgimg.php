...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
    ...
    <div class="pageheader">
      <h2><i class="fa fa-cog"></i> Picha ya Madharinyuma </h2>
    </div>
...
<br/>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label">Picha ya Madharinyuma</label>
...
Picha ya sasa : <br/><img src="../img/bg.jpg" width="600px;" height="400px" alt="IMG">
