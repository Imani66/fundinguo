...
$usid = $usid->fetch(PDO::FETCH_ASSOC);
 ...
 ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ongeza Wafanyakazi</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
Mfanyakazi ameongezeka kikamilifu!
...
Tafadhali chagua aina!!!!
  ...
  $(function() {
    $( "#datepicker" ).datepicker();
					...
					<label>Tafadhali chagua idara ya Wafanyakazi</label>
					
					<select name="stafftype" class="form-control" style="width:200px; height: 40px;">
					<option value="0">Chagua idara ya Wafanyakazi</option>
					<?php
